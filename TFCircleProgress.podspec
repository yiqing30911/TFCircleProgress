...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of TFCircleProgress.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/方涛/TFCircleProgress'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { '方涛' => '419512332@qq.com' }
  s.source           = { :git => 'https://github.com/方涛/TFCircleProgress.git', :tag => s.version.to_s }
